...
export function drawDoor(shapeParams, width=50, height=8, fill='#ff0000', stroke='#fff', strokeWidth=1, opacity=1, xPos=(shapeParams.innerWidth / 2) - 25, yPos=(shapeParams.innerHeight / 2) - 4, prevRotation=0, rotation=0, scaleX=1, scaleY=1) {
