...
export function drawCircle(options, radius={x:30,y:30}, fill='#', stroke='#698765', strokeWidth=1, opacity=1, xPos=(options.innerWidth / 2) - 15, yPos=(options.innerHeight / 2) - 15, prevRotation=0, rotation=0, scaleX=1, scaleY=1) {
