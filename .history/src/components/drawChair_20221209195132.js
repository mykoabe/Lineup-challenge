...
export function drawChair(shapeParams, width=20, height=24, fill='#0000ff', stroke='#fff', strokeWidth=1, opacity=1, xPos=(shapeParams.innerWidth / 2) - 10, yPos=(shapeParams.innerHeight / 2) - 10, prevRotation=0, rotation=0, scaleX=1, scaleY=1) {
